...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <spring:url value="/assets/vendors/themify-icons/css/themify-icons.css" var="mainCss" ></spring:url>
    <spring:url value="/assets/vendors/animate/animate.css" var="Main2Css" ></spring:url>
     
    <!-- font icons -->
    <link rel="stylesheet" href='<spring:url value="/resources/static/assets/vendors/themify-icons/css/themify-icons.css" />'>

    <link rel="stylesheet" href='<spring:url value="/resources/static/assets/vendors/animate/animate.css"/>'>
