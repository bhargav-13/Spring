				...
				<div id="product-carousel" class="carousel slide"
					...
					<div class="carousel-inner border">
						<div class="carousel-item active">
							<img class="w-100 h-100" style="height: 500px; width: 500px;"
								src="book_pdf/<%=b.getBook_pdf() %>" alt="Image">
						</div>
					</div>
			...
			<div class="col-lg-7 pb-5">
				...
				<div class="d-flex align-items-center mb-4 pt-2">
					<%
                         ...
                         %>
					<%
                               boolean flag1 = CartDao.checkCart(u.getUid(), b.getBid());
                               if(flag1==false){
                            %>
					<a href="add-to-cart.jsp?bid=<%=b.getBid()%>">
					...
					<%
                               ...
                               {
                        %>
					<a href="remove-from-cart.jsp?bid=<%=b.getBid()%>">
						<button class="btn btn-info px-3">
					...
					<%
								  boolean flag = WishlistDao.checkWishlist(u.getUid(), b.getBid());
								  if(flag==false){
								%>
					<a href="add-to-wishlist.jsp?bid=<%=b.getBid()%>">
					...
					<%
								  ...
								  {
								%>
					<a href="remove-from-wishlist.jsp?bid=<%=b.getBid()%>">
						<button class="btn btn-warning px-3">
    ...
    %>
					<div class="card product-item border-0">
						<div
							...
							<img class="img-fluid w-90" style="height: 400px; width: 300px"
								src="book_pdf/<%=b1.getBook_pdf() %>" alt="">
						</div>
						<div
						...
						<div
							...
							<a href="bookdetail.jsp?<%=b1.getBid() %>"
